...
const  ProjectBox = ({projectPhoto, projectName}) => {
  const desc = {
    ...
    TindogGithub : "https://github.com/Bhavik0203/TinDog.git",
    ...
    RogFreeGithub : "https://github.com/Bhavik0203/Rogfree.git",
    // RogFreeWebsite : "https://devanshsahni.github.io/Rog-Free/",

    AffiuentInterioDesc:"An innovative pet management web app enabling pet parents to create unique pet IDs, securely store and share vaccination records, and generate QR codes for pet profiles, enhancing safety.",
